...
<Image title="Order Fulfillment (Kotlin)" src="/page-assets/docs/Examples/examples/images/order-fulfillment-kotlin.excalidraw.svg"  />
...
We assume you have already read the [Getting Started](/docs/getting-started/) section and installed ZenWave SDK CLI and IntelliJ Plugin and are somewhat familiar with the concepts of DDD and Event-Driven Architecture.
...
OrderItem[] items
    ...
    Order *--down- OrderStatus
    Order *--down- OrderItem
    enum OrderStatus {
--
PLACED (1)
PAID (2)
...
State transitions are defined in `OrdersService` service interface using `@transition` decorator, see [Domain Modeling](#domain-modeling) below.
...
<RemoteCode
  ...
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/resources/public/apis/openapi.yml" />
...
<RemoteCode
  ...
  language="yaml" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/resources/public/apis/asyncapi.yml" />
...
<RemoteCode
  ...
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/zenwave-model.zdl" />

<RemoteCode
  title="`zenwave-scripts.zw` for Order Fulfillment Service"
  language="zdl" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/zenwave-scripts.zw" />
...
<RemoteCode
  ...
  language="zdl" collapsed={false} visibleRange="17,54"
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/zenwave-model.zdl" />
...
<RemoteCode
  ...
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/domain/Order.kt" />

<RemoteCode
  title="OrderStatus.kt - Generated Kotlin Enum"
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/domain/OrderStatus.kt" />

<RemoteCode
  title="OrderItem.kt - Generated Kotlin Value Object"
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/domain/OrderItem.kt" />
...
<RemoteCode
  ...
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/OrderRepository.kt" />
...
<RemoteCode
  title="OrdersService in ZDL with State Transitions annotations"
  language="zdl" collapsed={false} visibleRange="75,101"
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/zenwave-model.zdl" />
...
<RemoteCode
  ...
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/OrderService.kt" />

<RemoteCode
  title="OrderServiceImpl.kt - Generated Service Implementation"
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/OrderServiceImpl.kt" />
...
<RemoteCode
  ...
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/OrderApiController.kt" />

<RemoteCode
  title="OrderDTOsMapper.kt - Generated DTO Mapper"
  language="kotlin" collapsed={true}
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260329/examples/order-fulfillment-kotlin/src/main/kotlin/io/zenwave360/example/orderfulfillment/mappers/OrderDTOsMapper.kt" />
