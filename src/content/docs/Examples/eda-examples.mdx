...
<a href="/docs/examples/eda-examples/asyncapi-shopping-cart/">
       <Image style={{width: 725}} alt="AsyncAPI Shopping Cart"
              src="/page-assets/docs/Examples/examples/images/shopping-cart.excalidraw.svg"
       />
</a>
...
Follow detailed instructions at /posts/TransactionalOutBoxWithAsyncAPIAndSpringModulith/
...
<Image style={{width: 725}} alt="Transactional OutBox With AsyncAPI And Spring Modulith"
       ...
       dark="/posts/TransactionalOutBoxWithAsyncAPIAndSpringModulith/TransactionalOutBoxWithAsyncAPIAndSpringModulith-dark.png"
/>
