...
- <strong class={"orange"}>Unit/Vertical/Integration Tests</strong> for each OpenAPI Operation, it's up to you how you configure your BaseTest class.
- <strong class={"orange"}>Business Flow Tests</strong> for a group of OpenAPI Operations that work together as a Business Use Case.
