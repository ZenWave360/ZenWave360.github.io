...
> You can find a full example of a ZenWave SDK generated application in the [Customer Master Data Service (JPA)](/docs/examples/ddd-examples/customer-address-jpa/) example.
...
With [ZDLToAsyncAPIPlugin](/zenwave-sdk/plugins/zdl-to-asyncapi/) and [ZDLToOpenAPIPlugin](/zenwave-sdk/plugins/zdl-to-openapi/) plugins you can create complete draft versions of AsyncAPI and OpenAPI specifications from your annotated Services and Events.
...
Now you can ZenWave SDK [BackendApplicationDefaultPlugin](/zenwave-sdk/plugins/backend-application-default/) plugin to generate your backend application.
...
<Image alt="ZenWave SDK Backend Generation with IntelliJ Plugins"  src="/images/SDK-Backend-IntelliJ-Plugins.png" />
