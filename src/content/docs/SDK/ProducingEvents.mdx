...
While AsyncAPI is the source of truth for Event-Driven communication, with [ZDLToAsyncAPIPlugin](/zenwave-sdk/plugins/zdl-to-asyncapi/) plugins you can create complete draft version of AsyncAPI specification from your annotated Services and Events.
...
You can use [API-First AsyncAPI Maven Plugin](/zenwave-sdk/plugins/asyncapi-spring-cloud-streams3/#maven-plugin-configuration-api-first) to generate models (DTOs) and a producer implementation.
