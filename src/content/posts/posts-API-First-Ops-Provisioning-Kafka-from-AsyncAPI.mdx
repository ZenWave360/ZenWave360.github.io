...
description: "API First Ops extends API First from code generation to infrastructure provisioning: use the same AsyncAPI spec to describe Kafka topics, schemas, ACLs, retry topics, and DLQs, then generate Terraform from it."
...
image: "/posts/API-First-Ops-Provisioning-Kafka-from-AsyncAPI/api-first-ops-kafka-terraform-banner.png"
tags:
  - "API-First"
  - "API First Ops"
  - "AsyncAPI"
...
<Image src="api-first-ops-kafka-terraform-banner.png" alt="API First Ops: Provisioning Kafka Infrastructure from AsyncAPI" />
