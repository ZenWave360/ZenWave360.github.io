...
description: "How to save time and typing by generating KarateDSL tests from OpenAPI definitions with ZenWave SDK."
slug: "/posts/From-OpenAPI-to-KarateDSL-Tests/"
date: "2024-10-05T09:00:00+02:00"
...
image: "/posts/From-OpenAPI-to-KarateDSL-Tests/OpenAPI2Karate.excalidraw.svg"
tags:
  - "OpenAPI"
  - "API-First"
  - "Testing"
...
ZenWave SDK is composed of several plugins. One of them is the [OpenAPIKaratePlugin](/zenwave-sdk/plugins/openapi-karate/), which generates KarateDSL tests from OpenAPI definitions.
