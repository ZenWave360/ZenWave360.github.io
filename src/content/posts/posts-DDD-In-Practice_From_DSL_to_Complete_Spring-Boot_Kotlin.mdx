...
description: "In this article, we will explore how to use ZenWave360 to generate a complete SpringBoot Kotlin project from a Ubiquitous Language DSL model."
...
image: "/posts/DDD-In-Practice_From_DSL_to_Complete_Spring-Boot_Kotlin/automobile.png"
tags:
  - "ZenWave360"
  - "Ubiquitous Language"
  - "DDD"
...
- [DDD In Practice: From an Ubiquitous Language DSL to a Complete Spring Boot Kotlin Project](#ddd-in-practice-from-an-ubiquitous-language-dsl-to-a-complete-spring-boot-kotlin-project)
  ...
  - [Business Domain Modeling with ZenWave 360º](#business-domain-modeling-with-zenwave-360º)
...
ZDL is a compact, readable, and expressive language. It also works well as a Ubiquitous Language format, and thanks to the set of [ZenWave SDK Plugins](/zenwave-sdk/), it can be converted into different software artifacts and documentation, thus propagating the common language throughout the entire development process.
...
2. **Install the necessary tools**: Follow the instructions in [Getting Started](/docs/getting-started/) to install ZenWave SDK CLI and the [ZenWave Domain Model Editor for ZDL for IntelliJ](https://plugins.jetbrains.com/plugin/22858-zenwave-domain-model-editor-for-zdl).
...
<Image src="/page-assets/plugin-screenshot.png" style={{marginTop: '10px'}} />
...
- [Exposing a REST API](/docs/zenwave-sdk/exposing-a-rest-api/)
- [Producing Domain Events](/docs/zenwave-sdk/producing-domain-events/)
- [Consuming Async Commands](/docs/zenwave-sdk/consuming-async-commands/)
...
For more details on how to define REST APIs in ZDL, see the documentation on [Exposing a REST API](/docs/zenwave-sdk/exposing-a-rest-api/).
...
![ZenWaveModelEditor Plugins](/page-assets/posts/ZenWaveModelEditor-Plugins-light.png)
...
**🔗 [Kustomer with Address and Payment Methods in JPA](https://github.com/ZenWave360/zenwave-playground/tree/main/examples/kustomer-address-jpa)**
...
**Ready to get started?** Explore the [complete Kotlin example project](https://github.com/ZenWave360/zenwave-playground/tree/main/examples/kustomer-address-jpa) and see how ZenWave 360º can accelerate your next DDD project.
