...
description: "If you are familiar with OpenAPI and OpenAPI Generator API-First process, doing API-First with AsyncAPI is similar."
...
image: "/posts/API-First-with-AsyncAPI-And-ZenWave-SDK/api-first-with-asyncapi-banner.png"
tags:
  - "API-First"
  - "EDA"
  - "Specification"
...
![Client-server vs broker-based EDAs](/page-assets/posts/client-server-vs-broker-eda.excalidraw.svg)
