...
description: "Because writing YAML by hand is now fun... You can use `ZenWave Domain Language` models as IDL to generate OpenAPI v3 with ZenWave SDK."
...
image: "/posts/ZenWave_ZDL_As_IDL_for_OpenAPI/ZDL-To-OpenAPI-IDL-fragment-light.png"
tags:
  - "ZenWave SDK"
  - "Code Generator"
...
<img src="/images/EventStorming-ZDL-Mapping.png" />
...
Checkout the [ZDL documentation](/docs/event-driven-design/zenwave-domain-language/#services-and-commands) for more details about command methods.
...
```
Following these instructions for complete details about JBang and IntelliJ Editor: /docs/getting-started/
...
![Run With ZenWave Editor for IntelliJ](/page-assets/posts/RunWith-ZenWave-Editor-for-IntelliJ.png)
...
![Inline Path Parameters OpenAPI Generated](/page-assets/posts/InlinePathParameters-OpenAPI-Generated.png)
