...
description: "With ZenWave SDK plugins, you can generate strongly typed business interfaces, payload and header DTOs and several integration patterns like Transactional Outbox, DeadLetter Queue... from AsyncAPI definitions."
...
image: "/posts/ZenWave-AsyncAPI-Code-Generator/ZenWave360-AsyncAPI-SpringCloudStreams.excalidraw.svg"
tags:
  - "ZenWave SDK"
  - "Code Generator"
  - "Java"
...
![AsyncAPI and Spring Cloud Streams 3](/page-assets/posts/ZenWave360-AsyncAPI-SpringCloudStreams.excalidraw.svg)
...
See [AsyncAPI and Spring Cloud Streams 3 Configuration Options](/zenwave-sdk/plugins/asyncapi-spring-cloud-streams3/#options) and [ZenWave Maven Plugin](/zenwave-sdk/zenwave-sdk-maven-plugin/) for more details.
...
![ZenWave StreamCloudStreams AsyncAPI](/page-assets/posts/spring-cloud-streams3-generated.png)

### Provider vs Client

Because broker based API definitions are inherently **symmetrical** it's difficult to establish the roles of client/server. ZenWave generates code based on `provider` and `client` roles, where a `provider` "produces events" and "consumes commands". See [API-First with AsyncAPI](/posts/API-First-with-AsyncAPI-And-ZenWave-SDK/) page for more details on "publish/subscribe", "producer/consumer" and "provider/client" roles.
