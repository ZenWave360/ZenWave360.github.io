...
description: "Because writing YAML by hand is now fun... You can generate AsyncAPI v2/v3 from  JHipster JDL models with ZenWave SDK."
...
image: "/posts/JHipster-As-IDL-for-AsyncAPIv2/JDL-2-AsyncAPI.svg"
tags:
  - "ZenWave SDK"
  - "Code Generator"
  - "JHipster"
...
![JDL-2-AsyncAPI](/page-assets/posts/JDL-2-AsyncAPI.svg)
...
> See [JDL To AsyncAPI Generator](/zenwave-sdk/plugins/jdl-to-asyncapi/) for a complete list of options and [GitHub repository](https://github.com/zenwave360/zenwave-sdk) for install instructions.
...
- Supported [Payload Styles](/posts/API-First-with-AsyncAPI-And-ZenWave-SDK/#different-styles-of-event-messages): "Entity State Transfer" and "Domain Event" (for Create/Update/Delete events):
