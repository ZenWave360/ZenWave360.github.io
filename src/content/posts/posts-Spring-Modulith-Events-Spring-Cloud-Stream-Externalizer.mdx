...
The [ZenWave SDK AsyncAPI Generator](/zenwave-sdk/plugins/asyncapi-spring-cloud-streams3/) can generate full SDKs from AsyncAPI definitions, including:
...
- [Implementation Guide](/posts/TransactionalOutBoxWithAsyncAPIAndSpringModulith/): Step-by-step tutorial
...
- **AsyncAPI Integration**: Seamless integration with Spring Modulith Events and Spring Cloud Stream through [ZenWave SDK AsyncAPI Generator](/zenwave-sdk/plugins/asyncapi-spring-cloud-streams3/)
