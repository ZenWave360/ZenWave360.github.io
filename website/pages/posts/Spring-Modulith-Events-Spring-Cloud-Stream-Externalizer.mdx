...
image: https://opengraph.githubassets.com/42/ZenWave360/spring-modulith-events-spring-cloud-stream
...
<div style={{ textAlign: 'center' }}>
  <a href="https://github.com/ZenWave360/spring-modulith-events-spring-cloud-stream">
    <img src="https://opengraph.githubassets.com/42/ZenWave360/spring-modulith-events-spring-cloud-stream"
...
While these built-in externalizers cover common use cases, there are scenarios where you need more flexibility and control. I'm happy to introduce a new library that enhances Spring Modulith's event externalization features by integrating with Spring Cloud Stream.
...
```xml
<dependency>
    <groupId>io.zenwave360.spring.modulith</groupId>
    <artifactId>spring-modulith-events-spring-cloud-stream</artifactId>
