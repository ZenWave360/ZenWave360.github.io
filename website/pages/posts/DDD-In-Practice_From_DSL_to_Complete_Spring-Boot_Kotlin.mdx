...
<RemoteCode summary="ZDL Model" url="https://github.com/ZenWave360/zenwave-playground/blob/main/examples/customer-address-jpa/zenwave-model.zdl" language="zdl" collapsed={true} showLegend={true} />

would produce this:

<RemoteCode summary="OpenAPI Definition" url="https://github.com/ZenWave360/zenwave-playground/blob/main/examples/customer-address-jpa/src/main/resources/public/apis/openapi.yml" language="yaml" collapsed={true} showLegend={true} />
...
<div className="codegeneration">
  <div className="codegeneration__command">When using the `ZDLToAsyncAPIPlugin`, the following</div>
  <div className="codegeneration__source">
    <RemoteCode summary="ZDL Model" language="zdl" collapsed={true} showLegend={true}
  ...
  <div className="codegeneration__output">
    <RemoteCode summary="AsyncAPI Definition" language="yaml" collapsed={true} showLegend={true}
                url="https://github.com/ZenWave360/zenwave-playground/blob/main/examples/customer-address-jpa/src/main/resources/public/apis/asyncapi.yml"/>
  </div>
</div>
