...
ZenWave SDK expects most companies and teams to have their own starter base project. If you don't have one you can create one from https://start.spring.io or clone one of the ZenWave 360 base template projects from our GitHub repository.

- ZenWave Starter Project for JPA: TODO add link
- ZenWave Starter Project for MongoDB: TODO add link
