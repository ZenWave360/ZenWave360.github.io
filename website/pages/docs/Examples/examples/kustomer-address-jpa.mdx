...
<RemoteCode
  ...
  language="zdl"
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260120/examples/kustomer-address-jpa/zenwave-model.zdl" />
...
<RemoteCode
  ...
  language="zdl"
  url="https://github.com/ZenWave360/zenwave-playground/blob/v20260120/examples/kustomer-address-jpa/zenwave-scripts.zw" />
