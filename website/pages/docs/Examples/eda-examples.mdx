...
import shoppingCartLight from './examples/images/shopping-cart.excalidraw.svg';
...
This example demonstrates how to use AsyncAPI together with Avro schemas and the [ZenWaveSDK AsyncAPI Generator](/zenwave-sdk/plugins/asyncapi-generator)  to build a complete event-driven shopping cart application.
...
[AsyncAPI Shopping Cart](/docs/examples/eda-examples/asyncapi-shopping-cart/)

<a href="/docs/examples/eda-examples/asyncapi-shopping-cart/">
