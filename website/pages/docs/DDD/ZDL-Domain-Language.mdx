...
Inspired by JHipster JDL, and largely compatible with it, ZDL is a language for describing domain entities and their relationships, as well as services, commands, and events.
...
[<entity> | <enum> | <service> | <input> | <output> | <event>]*
```
