...
You can also reuse entity definitions or create a class hierarchy using `@copy` and `@extends` annotations.
...
With [ZDLToAsyncAPIPlugin](https://zenwave360.github.io/zenwave-sdk/plugins/zdl-to-asyncapi/) and [ZDLToOpenAPIPlugin](https://zenwave360.github.io/zenwave-sdk/plugins/zdl-to-openapi/) plugins you can create complete draft versions of AsyncAPI and OpenAPI specifications from your annotated Services and Events.
...
Now you can ZenWave SDK [BackendApplicationDefaultPlugin](https://zenwave360.github.io/zenwave-sdk/plugins/backend-application-default/) plugin to generate your backend application.
