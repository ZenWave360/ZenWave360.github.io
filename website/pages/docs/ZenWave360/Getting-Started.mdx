...
You can follow this tutorial for a dive into ZenWave Modeling and Code Generation: [DDD In Practice: From Ubiquitous Language DSL to Complete Spring-Boot Kotlin Project](/posts/DDD-In-Practice_From_DSL_to_Complete_Spring-Boot_Kotlin/)
