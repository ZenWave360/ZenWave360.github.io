...
## Create Your Spring-Boot base Project

ZenWave SDK only generates business logic code and tests. It is expected to work with any compatible Spring-Boot base project.
