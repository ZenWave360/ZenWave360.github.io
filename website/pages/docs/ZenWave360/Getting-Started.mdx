...
<CarouselProvider
    ...
    <Slider className="{s.slider}">
        <Slide index={0}>
            <h3>ZDL Config Section with SDK Plugins</h3>
            <Image src={zdlConfig} />
        </Slide>
        <Slide index={1}>
            <h3>ZDL Entities (with Nested Entities for MongoDB)</h3>
            <Image src={zdlEntities} />
        </Slide>
        <Slide index={2}>
            <h3>ZDL Entities (with Relationships for JPA)</h3>
            <Image src={zdlEntitiesJPA} />
        </Slide>
        <Slide index={3}>
            <h3>ZDL Service (with @annotations for REST API)</h3>
            <Image src={zdlService} />
        </Slide>
        <Slide index={4}>
            <h3>ZDL Events (with @annotations for AsyncAPI)</h3>
            <Image src={zdlEvents} />
        </Slide>
    </Slider>
    <ButtonFirst>First</ButtonFirst><ButtonBack>Back</ButtonBack><ButtonNext>Next</ButtonNext><ButtonLast>Last</ButtonLast>
</CarouselProvider>
